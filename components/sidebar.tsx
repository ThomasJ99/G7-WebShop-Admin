export default function Sidebar() {
  return (
    <div className="bg-white fixed top-0 left-0 z-99 w-64 h-full flex flex-col border-e">
      <aside id="default-sidebar" className="" aria-label="Sidebar">
        <div className="h-full py-4 overflow-y-auto">
          <ul className="space-y-2 font-medium">
            <li className="border-b-2 mt-2 mb-5">
              <a href="#" className=" bg-amber-100">
              ...
              <ul>
                ...
                <li>
                  <a href="#" className="flex items-center px-2 py-1.5 group">
                    ...
                    <span className="flex-1 ms-3">Analytics</span>
                  </a>
                </li>
      ...
      {/* Login bar */}
      <section className="border-t-2 mt-auto">
        {/* IMAGE */}
